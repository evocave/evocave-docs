  ...
  return (
    <>
      <div className="border-border flex items-center justify-between rounded-lg border px-4 py-3">
        ...
        <button onClick={handlePrint} className="text-muted-foreground hover:text-foreground transition-colors">
      ...
      {showModal && (
        ...
        >
          <div
            className="bg-background border-border mx-4 w-full max-w-sm rounded-xl border p-6 shadow-lg"
            onClick={e => e.stopPropagation()}
          >
            <div className="mb-6 flex items-center justify-between">
              <h3 className="text-foreground truncate pr-4 text-base font-semibold">{docTitle || 'Share this Doc'}</h3>
              <button
                onClick={() => setShowModal(false)}
            ...
            <div className="mb-6 flex items-center justify-center gap-3">
              {socials.map(({ platform, label, icon }) => (
                <Link
                  ...
                  title={label}
                  className="bg-secondary/50 border-border text-muted-foreground hover:text-foreground hover:bg-secondary flex h-11 w-11 items-center justify-center rounded-full border transition-colors"
                >
                  {icon}
                </Link>
              ))}
            ...
            <p className="text-muted-foreground mb-2 text-xs">Or copy link</p>
            <div className="border-border bg-secondary/20 flex items-center gap-2 rounded-lg border px-3 py-2">
