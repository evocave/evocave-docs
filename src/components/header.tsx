  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="text-muted-foreground hover:text-foreground border-border hover:bg-secondary/50 flex items-center gap-1.5 rounded-md border px-2.5 py-1.5 text-xs font-medium transition-colors"
      >
        {current.short}
      ...
      {open && (
        <div className="bg-background border-border absolute top-full right-0 z-50 mt-1.5 w-44 overflow-hidden rounded-lg border py-1 shadow-lg">
          {LANGUAGES.map(l => (
            <button
              key={l.code}
              onClick={() => {
              ...
              className={cn(
                'hover:bg-secondary/60 flex w-full items-center justify-between px-3 py-2 text-xs transition-colors',
...
function ThemeSwitcher() {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={() => setOpen(!open)}
        className="text-muted-foreground hover:text-foreground border-border hover:bg-secondary/50 flex size-8 items-center justify-center rounded-md border transition-colors"
      ...
      {open && (
        <div className="bg-background border-border absolute top-full right-0 z-50 mt-1.5 w-36 overflow-hidden rounded-lg border py-1 shadow-lg">
          {THEME_OPTIONS.map(t => {
            const TIcon = t.icon
            return (
              <button
                ...
                className={cn(
                  'hover:bg-secondary/60 flex w-full items-center gap-2.5 px-3 py-2 text-xs transition-colors',
                  theme === t.value ? 'text-foreground font-medium' : 'text-muted-foreground',
                )}
              >
